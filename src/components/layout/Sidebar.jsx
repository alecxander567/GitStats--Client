...
export const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 z-50 h-16 bg-dark/95 backdrop-blur-xl border-b border-white/10 px-4 flex items-center justify-between">
      ...
      {mobileMenuOpen && (
        <div
          className="md:hidden fixed inset-0 z-40 bg-dark/80 backdrop-blur-sm"
          onClick={toggleMobileMenu}
        />
      )}
      ...
      {/* Mobile Menu Drawer */}
      <div
        className={`md:hidden fixed top-0 left-0 z-50 w-72 h-full bg-dark/95 backdrop-blur-xl border-r border-white/10 transform transition-transform duration-300 ease-in-out ${
        ...
        <div className="flex items-center gap-3 px-6 py-6 border-b border-white/10">
          ...
          <div>
            ...
            <span className="text-sm text-white/40">GitHub Stats Tracker</span>
          </div>
        </div>
      ...
      <div className="hidden md:flex fixed left-0 top-0 h-screen w-64 bg-dark/95 backdrop-blur-xl border-r border-white/10 flex-col">
        <div className="flex items-center gap-3 px-6 py-6 border-b border-white/10">
          <img
            src="/stats_updater_logo_teal.svg"
            alt="Stats Updater"
      ...
      {/* Mobile Header Spacer - must match header's h-16 exactly */}
